<x-app-layout>
    ...
    <img class="w-40 absolute lg:top-[43%] lg:right-[84%] rotate-[123deg] " src="{{ asset('img/decoraciones/plantita-1.svg') }}" alt="">
    <img class="w-40 absolute lg:top-[50%] lg:right-[9%] " src="{{ asset('img/decoraciones/costal-semillas.svg') }}" alt="">
