<x-admin-layout>
    ...
    <div class="flex justify-end mb-4">
        <a class="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" href="{{route('admin.preguntas_frecuentes.create')}}">Agregar</a>
    </div>
            ...
            <tbody>
                @foreach ($preguntas_frecuentes as $pregunta_frecuente)
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4">
                            <a href="{{ route('admin.preguntas_frecuentes.edit', $pregunta_frecuente) }}">Editar</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
